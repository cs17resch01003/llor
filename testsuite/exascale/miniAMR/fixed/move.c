 ...
 *    * (later) diamond, solid diamond */
   ...
   #pragma omp parallel for ordered shared(sorted_index, num_refine, blocks, sorted_list, p2, mesh_size, refine_ghost, x_block_size, y_block_size, z_block_size, my_pe, parents)
